...
<div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    ...
    <li class="nav-item" data-target="#gestion-cueilleur">
        <a class="nav-link" href="<?= MAIN_URL ?>pages/admin/gestion-cueilleur.php">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <span class="nav-link-text ms-1">Gérer les cueilleurs</span>
        </a>
    </li>
    <li class="nav-item" data-target="#insertion-categorie-depense">
        <a class="nav-link" href="<?= MAIN_URL ?>pages/admin/insertion-categorie-depense.php">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <span class="nav-link-text ms-1">Insertion de Dépense</span>
        </a>
    </li>
    </ul>
</aside>