...
<div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
    <li class="nav-item" data-target="#ajoutcueillette">
        <a class="nav-link active" href="<?= MAIN_URL ?>pages/frontoffice/#ajoutcueillette">
        ...
        <span class="nav-link-text ms-1">new Cueillette</span>
        </a>
    </li>
    <li class="nav-item" data-target="#ajouterdepense">
        <a class="nav-link" href="<?= MAIN_URL ?>pages/frontoffice/#ajouterdepense">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Ajouter Depense</span>
        </a>
        </li>
    <li class="nav-item">
        <a class="nav-link  " href="./InsertionCueilleur.html">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <li class="nav-item">
        <a class="nav-link  " href="./InsertionDepenses.html">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <span class="nav-link-text ms-1">Insertion de Depenses</span>
        </a>
    </li>
    <li class="nav-item">
